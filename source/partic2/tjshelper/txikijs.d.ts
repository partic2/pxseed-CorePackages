    ...
    namespace tjs {
        ...
        */
        interface Writer {
            ...
            */
            write(buf: Uint8Array<ArrayBuffer>): Promise<number>;
        }
        ...
        */
        ...
        const engine : {
             ...
             */
            compile: (code: Uint8Array<ArrayBuffer>) => CompiledCode;
             ...
             */
            serialize: (compiledCode: CompiledCode) => Uint8Array<ArrayBuffer>;
             ...
             */
            deserialize: (bytes: Uint8Array<ArrayBuffer>) => CompiledCode;
        ...
        */
        ...
        interface FileHandle {
            ...
            */
            read(buffer: Uint8Array<ArrayBuffer>, offset?: number): Promise<number|null>;
            ...
            */
            write(buffer: Uint8Array<ArrayBuffer>, offset?: number): Promise<number>;
        ...
        */
        ...
        interface DatagramEndpoint {
            recv(buf: Uint8Array<ArrayBuffer>): Promise<number>;
            send(buf: Uint8Array<ArrayBuffer>, addr?: Address): Promise<DatagramData>;
            close(): void;
            localAddress: Address;
            remoteAddress: Address;
        }
