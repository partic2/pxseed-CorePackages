...
//Before Top level await is supported, How to ensure inited is resolved?
export let __inited__=(async ()=>{
    if(globalThis.document!=undefined){
            ...
            render(props?: React.RenderableProps<{ object: any; }, any> | undefined, state?: Readonly<{}> | undefined, context?: any): React.ComponentChild {
                ...
                if(this.state.viewer!=null){
                    ...
                    return <div>
                        ...
                        <div style={{paddingLeft:'1em'}}>{
                            keys.map((v1)=>{
                                return <ObjectViewerImpl name={v1} object={robj[v1]} key={'index'+v1}/>
                            })
                        }</div>:null}
                    </div>
                }
        ...
        ObjectViewer=ObjectViewerImpl;
        class HtmlViewerImpl extends React.Component<{name:string,object:{html?:string,js?:string}}>{
